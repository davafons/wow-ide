...
final class TerminiRuntime: ObservableObject {
    ...
    private init() {
        #if canImport(AppKit)
        // The embedding app owns activation policy. This overlay is a menu
        // accessory and must not become a regular app when Ghostty starts.
        ...
        #if canImport(AppKit)
        // The host grants keyboard focus only after a terminal click.
        #endif
    }
